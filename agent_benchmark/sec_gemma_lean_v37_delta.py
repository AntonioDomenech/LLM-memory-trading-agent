"""Committed-blob-only implementation delta proof for SEC/Gemma v3.7.
...
MANIFEST_VERSION = "aapl-sec-gemma-lean-v37-implementation-delta-v1"
PREREG_COMMIT = "fcebe9b6de9d2de81e7cc9c79b011b2e0ca1051a"
PREREG_TREE = "c2e141d3546da5d11d0ab9d2e120b0685798eac6"
PREREG_DOC_PATH = "docs/aapl_sec_gemma_lean_evidence_v3_7.md"
PREREG_DOC_BLOB = "ec49b15630eac71132d321c88e8e02f7cfa5a488"
PREREG_DOC_SHA256 = (
    "645b4adafc56e71bc71d41780501db85963b5a485d3841230f5a2075b13143a7"
)
IMPLEMENTATION_BASE_COMMIT = "6f6752416025b5200b7bcb2d3dc96e55f2c456aa"
IMPLEMENTATION_BASE_TREE = "234ea6ec46727b35ec7396b375032910b7824736"
_COUNTERPART_MECHANICAL_REPLACEMENTS = (
    ("sec_gemma_lean_v36", "sec_gemma_lean_v37"),
    ("SecGemmaLeanV36", "SecGemmaLeanV37"),
    ("V36", "V37"),
    ("v36", "v37"),
    ("v3_6", "v3_7"),
    ("v3-6", "v3-7"),
...
class CounterpartRule:
    """Exact committed-v3.3 comparison contract for one v3.7 delta path.

    ``expected_candidate_sha256`` binds the complete v3.7 blob for ordinary
    ...
    def validate(self, path: str) -> None:
        ...
        if modes[0]:
            ...
            if (
                path != "tests/test_sec_gemma_lean_v37_delta.py"
                or redacted_name != "V37_DELTA_MODULE_SHA256"
            ...
            path != "agent_benchmark/sec_gemma_lean_v37_delta.py"
            or anchor_path != "tests/test_sec_gemma_lean_v37_delta.py"
            or anchor_name != "V37_DELTA_MODULE_SHA256"
        ):
        ...
        expected_exclusions = {
            ...
            "tests/test_sec_gemma_lean_v37_delta.py": (
                "assignment|$module.V37_DELTA_MODULE_SHA256|1",
            ),
        }.get(path, ())
...
def _counterpart_evidence(
    ...
    *,
    ...
    """Prove one committed v3.7 blob against its pinned v3.3 counterpart."""
...
def build_delta_manifest(
    ...
    *,
    ...
    v37_paths = {entry.path for entry in implementation_diff}
    overlap = inherited_paths & v37_paths
    if overlap:
        raise DeltaValidationError(
            "inherited-at-prereg blobs changed in implementation: " + ",".join(sorted(overlap))
        )
    if v37_paths != set(allow_spec.path_rules):
        unknown = sorted(v37_paths - set(allow_spec.path_rules))
        missing = sorted(set(allow_spec.path_rules) - v37_paths)
    ...
    for entry in implementation_diff:
        ...
        entry_json["classification"] = "v37_implementation_delta"
    ...
    for entry in parent_to_implementation:
        ...
        elif entry.path in v37_paths:
            classification = "v37_implementation_delta"
        else:
    ...
    if {entry["path"] for entry in classified_parent_paths} != inherited_paths | v37_paths:
...
# This table binds the exact twelve-file v3.7 projection derived from v3.6.
_V36_CLONE_PATH_RULES = {
    "agent_benchmark/sec_gemma_lean_v37_acquisition.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="a6ff102b3ee96883c2720c6fb4a07e2a35b7d98ee4978f5bfcb9076ec3544b31",
        expected_symbol_count=216,
        expected_import_inventory_sha256="6da6926756bd2af3eb4993b624167566e79ba5ccb210bfa55dbe0ce8556e880c",
        expected_import_count=29,
    ),
    "agent_benchmark/sec_gemma_lean_v37_delta.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="72be87f01f2884dafdabf0b99618cf198a58432e90f7d8a74de592ad7d9270f7",
    ...
    "agent_benchmark/sec_gemma_lean_v37_journal.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="7c3d033c1a58f8dcc4e2a1592bc0d3e074cf0cf4b2df57c1535c251a0005a6eb",
    ...
    "agent_benchmark/sec_gemma_lean_v37_preflight.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="884a73eec06c5bacce604384bf8bc8c032255ebc222266f6730a27dd76ce2a00",
        expected_symbol_count=144,
        expected_import_inventory_sha256="8f4b7e565b065bde6048adabd135f75e349e04fda90fea398c0343ec8c2715e4",
        expected_import_count=25,
    ),
    "agent_benchmark/sec_gemma_lean_v37_source.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="fd1a2aee282c5f455cabe6fa538094931981eb06a163e868a1058d0d37671e9f",
    ...
    "agent_benchmark/sec_gemma_lean_v37_transport.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="15f3514bc97050a1114bce3b38b32d4087fdee5303584f90f08458412e030ed3",
    ...
    "tests/test_sec_gemma_lean_v37_acquisition.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="00a4b4a67cd365ae454de7b4a17d0f3877d118b0254d71c9dff121e77719b5b8",
        expected_import_count=21,
    ),
    "tests/test_sec_gemma_lean_v37_delta.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="60f41ec4ccd8a3b9ee689dedc35125a3b624d41ab4cf062e97d9aa193cfd65c7",
        expected_symbol_count=53,
        expected_import_inventory_sha256="ae172c13d27dfdd7ec49e9057da4d6986320ee9e5b73287437ce3ee5d9ff26b6",
        expected_import_count=10,
    ),
    "tests/test_sec_gemma_lean_v37_journal.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="e2edc1b5acc7bf9477fd46d8a7e47129b6235463f6ef50e8e860d0af815d1876",
        expected_import_count=9,
    ),
    "tests/test_sec_gemma_lean_v37_preflight.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="5723a49dcbe1ae30bf9cae1935c6fc79606ecdad3738315f566e5fcb94bd27bf",
        expected_import_count=11,
    ),
    "tests/test_sec_gemma_lean_v37_source.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="96a9373e72f611a22e77bcec8fcef9c39800f1f0a8115eb69d52936295f7363c",
        expected_import_count=12,
    ),
    "tests/test_sec_gemma_lean_v37_transport.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="cba31ad414ed2875dc607440bc38121ac6be6f8e94711d27af40cf5302067afa",
        expected_import_count=16,
    ),
}
# These are exactly the twelve additive v3.7 paths.  No shared-file
# modification is admitted when DEFAULT_ALLOW_SPEC is built.
_V37_IMPLEMENTATION_PATHS = (
...
_COUNTERPART_RULE_DATA = {'agent_benchmark/sec_gemma_lean_v37_acquisition.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v36_acquisition.py',
                                                       'excluded_change_symbol_ids': (),
                                                       'expected_candidate_sha256': '082238efe69b29048a9951d6caf576c12e1a96c2e93138bbb55611989024d308',
 ...
 'agent_benchmark/sec_gemma_lean_v37_delta.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v36_delta.py',
                                                 'excluded_change_symbol_ids': ('assignment|$module._COUNTERPART_RULE_DATA|1',),
                                                 'expected_candidate_sha256': None,
                                                 'expected_changed_import_specs': (),
                                                 'expected_changed_symbol_evidence_sha256': 'f173e47d908eb0d24c7c624d59ffa79e0b9ca6a487e741c622cc220e37dd668b',
                                                 ...
                                                 'expected_mechanical_counts': (43,
                                                                                ...
                                                                                7),
                                                 'expected_redacted_candidate_sha256': None,
                                                 'external_sha256_anchor_assignment': 'V37_DELTA_MODULE_SHA256',
                                                 'external_sha256_anchor_path': 'tests/test_sec_gemma_lean_v37_delta.py',
                                                 'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v37_journal.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v36_journal.py',
                                                   'excluded_change_symbol_ids': (),
                                                   'expected_candidate_sha256': 'f9b3a6de35c20bdb6896a03854cfdbd12a60138b93d5fcaa4b6c0df1f56fc5ee',
                                                   'expected_changed_import_specs': (),
                                                   'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                   'expected_changed_symbol_ids': (),
                                                   ...
                                                   'external_sha256_anchor_path': None,
                                                   'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v37_preflight.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v36_preflight.py',
                                                     'excluded_change_symbol_ids': (),
                                                     'expected_candidate_sha256': 'f192f4bab33c5980428e436457429e88cf5de069dda18887c5f93ef915fd51c8',
                                                     'expected_changed_import_specs': (),
                                                     'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                     'expected_changed_symbol_ids': (),
                                                     ...
                                                     'external_sha256_anchor_path': None,
                                                     'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v37_source.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v36_source.py',
                                                  'excluded_change_symbol_ids': (),
                                                  'expected_candidate_sha256': 'd063d3a95d4ea2b3eb21105c3e7c03dc269479570f1df43d858f8ab42b20ca46',
                                                  'expected_changed_import_specs': ('from:1:sec_session_calendar:EXPECTED_MARKET_HISTORY_SESSIONS,EXPECTED_SESSIONS,validate_aapl_session_calendar,validate_market_history_session_calendar',),
                                                  'expected_changed_symbol_evidence_sha256': '3ee5eaca2c60d2421161550e1772873e9ae847e5dc5ba72ba5f629c962661010',
                                                  'expected_changed_symbol_ids': ('assignment|$module._EXPECTED_SESSION_SET|1',
                                                  ...
                                                  'external_sha256_anchor_path': None,
                                                  'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v37_transport.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v36_transport.py',
                                                     'excluded_change_symbol_ids': (),
                                                     'expected_candidate_sha256': 'bc0de296851ec6fd853a261ca2bc4e5cf04907f12080144479b4559fe905a28a',
                                                     'expected_changed_import_specs': (),
                                                     'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                     'expected_changed_symbol_ids': (),
                                                     ...
                                                     'external_sha256_anchor_path': None,
                                                     'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v37_acquisition.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v36_acquisition.py',
                                                  'excluded_change_symbol_ids': (),
                                                  'expected_candidate_sha256': 'd93ea7c7b65dc1f3c7f127b4855acac70e4722d117728fbe121384c1e74b4ab1',
                                                  'expected_changed_import_specs': (),
                                                  'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                  'expected_changed_symbol_ids': (),
                                                  ...
                                                  'external_sha256_anchor_path': None,
                                                  'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v37_delta.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v36_delta.py',
                                            'excluded_change_symbol_ids': ('assignment|$module.V37_DELTA_MODULE_SHA256|1',),
                                            'expected_candidate_sha256': None,
                                            'expected_changed_import_specs': (),
                                            'expected_changed_symbol_evidence_sha256': '45efcdb481c1d3a975cbedfeed3e24c141a8736e3b276477fdf4b6ccdb64e823',
                                            'expected_changed_symbol_ids': ('assignment|$module.EXPECTED_V37_COUNTERPARTS|1',
                                                                            ...
                                                                            'function|test_checker_rejects_calendar_suffix_weakening_caller_broadening_and_left_edge_special_case|1',
                                            ...
                                            'expected_mechanical_counts': (18, 0, 8, 1, 1, 0, 0),
                                            'expected_redacted_candidate_sha256': 'ca8560a859154ff3b84e9bffe79b3e3b80a10fc315774ff33882f3838f0831db',
                                            'external_sha256_anchor_assignment': None,
                                            'external_sha256_anchor_path': None,
                                            'redacted_literal_assignment': 'V37_DELTA_MODULE_SHA256'},
 'tests/test_sec_gemma_lean_v37_journal.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v36_journal.py',
                                              'excluded_change_symbol_ids': (),
                                              'expected_candidate_sha256': '18b93d0306185bea668e4424068e67e9449f5014d7258f1eb1cd7251c521466f',
                                              'expected_changed_import_specs': (),
                                              'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                              'expected_changed_symbol_ids': (),
                                              ...
                                              'external_sha256_anchor_path': None,
                                              'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v37_preflight.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v36_preflight.py',
                                                'excluded_change_symbol_ids': (),
                                                'expected_candidate_sha256': '01f6b0ee9d7648a42c62a6c584bc51053f4a8859fee34605b44867ba049a65b7',
                                                'expected_changed_import_specs': (),
                                                'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                'expected_changed_symbol_ids': (),
                                                ...
                                                'external_sha256_anchor_path': None,
                                                'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v37_source.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v36_source.py',
                                             'excluded_change_symbol_ids': (),
                                             'expected_candidate_sha256': '2df46ca80507aaa06e26d67327fa13a524281e821cc8348ace8cab61e8d478d8',
                                             'expected_changed_import_specs': (),
                                             'expected_changed_symbol_evidence_sha256': 'dfda76ee76c33919bade42224d6c2be268c2e1247138cef8de66e8611d2a00fd',
                                             'expected_changed_symbol_ids': ('function|_synthetic_full_rehearsal_inputs|1',
                                                                             'function|test_authoritative_calendar_is_exact_and_compact_identity_is_sealed|1',
                                                                             'function|test_synthetic_full_size_three_stage_rehearsal_replay_and_prefix|1'),
                                             'expected_mechanical_counts': (2, 54, 0, 0, 0, 0, 1),
                                             'expected_redacted_candidate_sha256': None,
                                             'external_sha256_anchor_assignment': None,
                                             'external_sha256_anchor_path': None,
                                             'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v37_transport.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v36_transport.py',
                                                'excluded_change_symbol_ids': (),
                                                'expected_candidate_sha256': 'ed519f5f0ec056f73d12be1e284a209b630db4f7f4b37c73cf7386f1f3b6bf5c',
                                                'expected_changed_import_specs': (),
                                                'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                'expected_changed_symbol_ids': (),
...
_DEFAULT_EXISTING_PATH_RULES = {
    path: _V36_CLONE_PATH_RULES[path] for path in _V37_IMPLEMENTATION_PATHS
}
_DEFAULT_COUNTERPART_RULES = {
    path: _counterpart_rule_from_data(_COUNTERPART_RULE_DATA[path])
    for path in _V37_IMPLEMENTATION_PATHS
}
