"""Committed-blob-only implementation delta proof for SEC/Gemma v3.5.
...
MANIFEST_VERSION = "aapl-sec-gemma-lean-v35-implementation-delta-v1"
PREREG_COMMIT = "50d7e21a0171edf0f356622c2160f996296fd503"
PREREG_TREE = "176ce7b59d89513a74078d487c0ea15ea40e64d6"
PREREG_DOC_PATH = "docs/aapl_sec_gemma_lean_evidence_v3_5.md"
PREREG_DOC_BLOB = "92c4d0773dbd2b4338a1d00797861927480b4eab"
PREREG_DOC_SHA256 = (
    "bdf2c07db01717cb2cf4eb4fe002e20a93d4ac0aa2e1a5b3534da8ff22259bf1"
)
IMPLEMENTATION_BASE_COMMIT = "359dd70af9fd4d2fa352c4514e8cd9c10d625aa3"
IMPLEMENTATION_BASE_TREE = "7d775f342fcf2199bbf6c8ae513d627ead886aa0"
_COUNTERPART_MECHANICAL_REPLACEMENTS = (
    ("sec_gemma_lean_v34", "sec_gemma_lean_v35"),
    ("SecGemmaLeanV34", "SecGemmaLeanV35"),
    ("V34", "V35"),
    ("v34", "v35"),
    ("v3_4", "v3_5"),
    ("v3-4", "v3-5"),
...
class CounterpartRule:
    """Exact committed-v3.3 comparison contract for one v3.5 delta path.

    ``expected_candidate_sha256`` binds the complete v3.5 blob for ordinary
    ...
    def validate(self, path: str) -> None:
        ...
        if modes[0]:
            ...
            if (
                path != "tests/test_sec_gemma_lean_v35_delta.py"
                or redacted_name != "V35_DELTA_MODULE_SHA256"
            ...
            path != "agent_benchmark/sec_gemma_lean_v35_delta.py"
            or anchor_path != "tests/test_sec_gemma_lean_v35_delta.py"
            or anchor_name != "V35_DELTA_MODULE_SHA256"
        ):
            raise DeltaValidationError(f"{path}: invalid external-anchor contract")
        expected_exclusions = {
            "agent_benchmark/sec_gemma_lean_v35_delta.py": (
                "assignment|$module._COUNTERPART_RULE_DATA|1",
            ),
            "tests/test_sec_gemma_lean_v35_delta.py": (
                "assignment|$module.V35_DELTA_MODULE_SHA256|1",
            ),
        }.get(path, ())
...
def _counterpart_evidence(
    ...
    *,
    ...
    """Prove one committed v3.5 blob against its pinned v3.3 counterpart."""
...
def build_delta_manifest(
    ...
    *,
    ...
    v35_paths = {entry.path for entry in implementation_diff}
    overlap = inherited_paths & v35_paths
    if overlap:
        raise DeltaValidationError(
            "inherited-at-prereg blobs changed in implementation: " + ",".join(sorted(overlap))
        )
    if v35_paths != set(allow_spec.path_rules):
        unknown = sorted(v35_paths - set(allow_spec.path_rules))
        missing = sorted(set(allow_spec.path_rules) - v35_paths)
    ...
    for entry in implementation_diff:
        ...
        entry_json["classification"] = "v35_implementation_delta"
    ...
    for entry in parent_to_implementation:
        ...
        elif entry.path in v35_paths:
            classification = "v35_implementation_delta"
        else:
    ...
    if {entry["path"] for entry in classified_parent_paths} != inherited_paths | v35_paths:
...
# This table binds the exact twelve-file v3.5 projection derived from v3.4.
_V34_CLONE_PATH_RULES = {
    "agent_benchmark/sec_gemma_lean_v35_acquisition.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="048f6cb0c4782e10870bbda3f9b22b3b671300e054a6334734d0cfced62df41a",
        expected_symbol_count=216,
        expected_import_inventory_sha256="39b867b635c7ebc02947777c3ac79d70c9b66e7195dbbc3b4a453323e3d8fcd0",
        expected_import_count=29,
    ),
    "agent_benchmark/sec_gemma_lean_v35_delta.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="9a8172be92df785c690502841ad6fd86a85060513a09f0cbf03ef18b82ffde63",
    ...
    "agent_benchmark/sec_gemma_lean_v35_journal.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="2a0bc936b248cb170034d4d8ce20bededc056062b933ef1f45e17b3d87688894",
    ...
    "agent_benchmark/sec_gemma_lean_v35_preflight.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="5469b306834e1e671ebc27ccf40c72abed3ab4c28b1a14b4db45212becd24225",
        expected_symbol_count=144,
        expected_import_inventory_sha256="23e32eaf8cd173d8f4d239be7ee09ef846031bd2ee8b5164ff89e26368ff3d30",
        expected_import_count=25,
    ),
    "agent_benchmark/sec_gemma_lean_v35_source.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="5444b2f603232968b606ce06c0df522442271447cda449f9d4aa269d45954374",
    ...
    "agent_benchmark/sec_gemma_lean_v35_transport.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="f6711ebcb499cfdfe6c1c42f71de4f26c2993eeae3e3228280b89b9b976d616c",
    ...
    "tests/test_sec_gemma_lean_v35_acquisition.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="454ffd682d30b9f8d5c5c2a630d875a08d42374c31469cc34633a4d8090ed06b",
        expected_import_count=21,
    ),
    "tests/test_sec_gemma_lean_v35_delta.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="19804153d2c1b7a0c5b7874cfee905a2493a9e94ba833d8e14d9adfd7109b545",
        expected_symbol_count=51,
        expected_import_inventory_sha256="647867febc49315d0e61258050a77b116a2f33c5e31d4e43dc423e355f02d373",
        expected_import_count=10,
    ),
    "tests/test_sec_gemma_lean_v35_journal.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="d2c66bbde79addab6b4c64de17c74b47de3eca94111c3a300da89b01e845370d",
        expected_import_count=9,
    ),
    "tests/test_sec_gemma_lean_v35_preflight.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="d760d26688e895f8631b752574b4fd05c3f93727ed0d5d1d2df8bc964301dfdb",
        expected_import_count=11,
    ),
    "tests/test_sec_gemma_lean_v35_source.py": PathRule(
        "A", (), (),
        expected_symbol_inventory_sha256="abec4351c4e8a84f9ccc3c66686fe3ff6ef4f13555deacd84a4fb9fefe3a8414",
        expected_symbol_count=76,
        expected_import_inventory_sha256="1f4df9d5182775ddc71a7778d33c62f822bd1dac7b57711c637c968280c302fd",
        expected_import_count=12,
    ),
    "tests/test_sec_gemma_lean_v35_transport.py": PathRule(
        "A", (), (),
        ...
        expected_import_inventory_sha256="7a0f56e70eb9a9e7daa4d8ba5fd548cfe68e4307c8b4e0d30592af659a2cca1e",
        expected_import_count=16,
    ),
}
# These are exactly the twelve additive v3.5 paths.  The two shared-file
# modifications are selected separately when DEFAULT_ALLOW_SPEC is built.
_V35_IMPLEMENTATION_PATHS = (
    "agent_benchmark/sec_gemma_lean_v35_acquisition.py",
    "agent_benchmark/sec_gemma_lean_v35_delta.py",
    "agent_benchmark/sec_gemma_lean_v35_journal.py",
    "agent_benchmark/sec_gemma_lean_v35_preflight.py",
    "agent_benchmark/sec_gemma_lean_v35_source.py",
    "agent_benchmark/sec_gemma_lean_v35_transport.py",
    "tests/test_sec_gemma_lean_v35_acquisition.py",
    "tests/test_sec_gemma_lean_v35_delta.py",
    "tests/test_sec_gemma_lean_v35_journal.py",
    "tests/test_sec_gemma_lean_v35_preflight.py",
    "tests/test_sec_gemma_lean_v35_source.py",
    "tests/test_sec_gemma_lean_v35_transport.py",
)
...
_COUNTERPART_RULE_DATA = {'agent_benchmark/sec_gemma_lean_v35_acquisition.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v34_acquisition.py',
                                                       'excluded_change_symbol_ids': (),
                                                       'expected_candidate_sha256': 'bec9dac81d485b00cf758dd1651cdab6adf5c4c690296bcfe6bb614aed51e319',
 ...
 'agent_benchmark/sec_gemma_lean_v35_delta.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v34_delta.py',
                                                 'excluded_change_symbol_ids': ('assignment|$module._COUNTERPART_RULE_DATA|1',),
                                                 'expected_candidate_sha256': None,
                                                 'expected_changed_import_specs': (),
                                                 'expected_changed_symbol_evidence_sha256': '61fa05c7096922331d2e17e7ca3c8633fdb5021e6a047d669a5954bc6ccabc04',
                                                 ...
                                                 'expected_mechanical_counts': (43,
                                                                                ...
                                                                                7),
                                                 'expected_redacted_candidate_sha256': None,
                                                 'external_sha256_anchor_assignment': 'V35_DELTA_MODULE_SHA256',
                                                 'external_sha256_anchor_path': 'tests/test_sec_gemma_lean_v35_delta.py',
                                                 'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v35_journal.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v34_journal.py',
                                                   'excluded_change_symbol_ids': (),
                                                   'expected_candidate_sha256': '28922e09bdb3801da3b7a472f4eafe49d180cc2253f81d7c3610bce1a4d683ba',
                                                   'expected_changed_import_specs': (),
                                                   'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                   'expected_changed_symbol_ids': (),
                                                   ...
                                                   'external_sha256_anchor_path': None,
                                                   'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v35_preflight.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v34_preflight.py',
                                                     'excluded_change_symbol_ids': (),
                                                     'expected_candidate_sha256': '0db535de3030144b4522d29c5362292adbd2c9994becca601df812a884981d7a',
                                                     'expected_changed_import_specs': (),
                                                     'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                     'expected_changed_symbol_ids': (),
                                                     ...
                                                     'external_sha256_anchor_path': None,
                                                     'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v35_source.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v34_source.py',
                                                  'excluded_change_symbol_ids': (),
                                                  'expected_candidate_sha256': 'bc596e37d15b499bcb5d3152d66d9bc501283c1a908d1f1909b21ed95bbf4c53',
                                                  'expected_changed_import_specs': (),
                                                  'expected_changed_symbol_evidence_sha256': '74110bb0fdb3e92a9ecca2d95b196d120bee63c44076db8e6b6f21450dcd8746',
                                                  ...
                                                  'external_sha256_anchor_path': None,
                                                  'redacted_literal_assignment': None},
 'agent_benchmark/sec_gemma_lean_v35_transport.py': {'counterpart_path': 'agent_benchmark/sec_gemma_lean_v34_transport.py',
                                                     'excluded_change_symbol_ids': (),
                                                     'expected_candidate_sha256': '6b18622d788fcef72949eb82383c84a75f5d674525f58f5ea0f7a4a0d4b07f89',
                                                     'expected_changed_import_specs': (),
                                                     'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                     'expected_changed_symbol_ids': (),
                                                     ...
                                                     'external_sha256_anchor_path': None,
                                                     'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v35_acquisition.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v34_acquisition.py',
                                                  'excluded_change_symbol_ids': (),
                                                  'expected_candidate_sha256': '006a4320e66c645124add20b66e3f7db739f246f1fb15d979bb130104cd43461',
                                                  'expected_changed_import_specs': (),
                                                  'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                  'expected_changed_symbol_ids': (),
                                                  ...
                                                  'external_sha256_anchor_path': None,
                                                  'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v35_delta.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v34_delta.py',
                                            'excluded_change_symbol_ids': ('assignment|$module.V35_DELTA_MODULE_SHA256|1',),
                                            'expected_candidate_sha256': None,
                                            'expected_changed_import_specs': (),
                                            'expected_changed_symbol_evidence_sha256': '9b91929b3b99e252b1cf48be807e5d94b9f78867ce5e9e0a697498f474902096',
                                            'expected_changed_symbol_ids': ('assignment|$module.EXPECTED_V35_COUNTERPARTS|1',
                                                                            ...
                                                                            'function|test_checker_rejects_family_asymmetric_hws_scope_expansion_and_observed_special_case|1',
                                            ...
                                            'expected_redacted_candidate_sha256': '6a3c86bd6e6195fcfb98c26e6e94a02b4838c5e4199137fd6c08ea4c070b4bd7',
                                            'external_sha256_anchor_assignment': None,
                                            'external_sha256_anchor_path': None,
                                            'redacted_literal_assignment': 'V35_DELTA_MODULE_SHA256'},
 'tests/test_sec_gemma_lean_v35_journal.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v34_journal.py',
                                              'excluded_change_symbol_ids': (),
                                              'expected_candidate_sha256': '72c34be8dc1cbad638198285bcf4a398e2318daa12b71c3ded589bef00c0ce83',
                                              'expected_changed_import_specs': (),
                                              'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                              'expected_changed_symbol_ids': (),
                                              ...
                                              'external_sha256_anchor_path': None,
                                              'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v35_preflight.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v34_preflight.py',
                                                'excluded_change_symbol_ids': (),
                                                'expected_candidate_sha256': '1a3ca2148826bed2f99e5f77bb28ef9fe70ed0f05993a799c5749da294e0ebf3',
                                                'expected_changed_import_specs': (),
                                                'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                'expected_changed_symbol_ids': (),
                                                ...
                                                'external_sha256_anchor_path': None,
                                                'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v35_source.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v34_source.py',
                                             'excluded_change_symbol_ids': (),
                                             'expected_candidate_sha256': 'c316d63984808ea3dbe5ab5f97c7f00404a4c3e49774390e09ee49c44c1df750',
                                             'expected_changed_import_specs': (),
                                             'expected_changed_symbol_evidence_sha256': 'a75e647bf77c8ace4b76dd771801c95108ae8887f88d4f72c43ff2a517d1ead1',
                                             'expected_changed_symbol_ids': ('function|test_plain_header_form_ascii_horizontal_whitespace_is_family_neutral|1',),
                                             'expected_mechanical_counts': (2, 50, 0, 0, 0, 0, 1),
                                             'expected_redacted_candidate_sha256': None,
                                             'external_sha256_anchor_assignment': None,
                                             'external_sha256_anchor_path': None,
                                             'redacted_literal_assignment': None},
 'tests/test_sec_gemma_lean_v35_transport.py': {'counterpart_path': 'tests/test_sec_gemma_lean_v34_transport.py',
                                                'excluded_change_symbol_ids': (),
                                                'expected_candidate_sha256': 'e66c9f9410fd1a4894de30315f6d71d17c30bff526a51b1b97c54aed094e2c9b',
                                                'expected_changed_import_specs': (),
                                                'expected_changed_symbol_evidence_sha256': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945',
                                                'expected_changed_symbol_ids': (),
...
_DEFAULT_EXISTING_PATH_RULES = {
    path: _V34_CLONE_PATH_RULES[path] for path in _V35_IMPLEMENTATION_PATHS
}
_DEFAULT_COUNTERPART_RULES = {
    path: _counterpart_rule_from_data(_COUNTERPART_RULE_DATA[path])
    for path in _V35_IMPLEMENTATION_PATHS
}
