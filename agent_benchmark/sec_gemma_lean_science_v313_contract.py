"""Pure, fail-closed contract for the v3.13 SEC-to-science bridge.
...
CONTRACT_VERSION: Final[str] = "aapl-sec-gemma-lean-science-v3-13"
CONTRACT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-contract-v1"
)
BRANCH_NAME: Final[str] = "codex/aapl-sec-gemma-lean-science-v3-13"
...
BASE_COMMIT: Final[str] = "342f8086bc9d9763d09a38c11ed6850da395ead5"
BASE_TREE: Final[str] = "4228ff17daca87b1d261c4e02b628607cba9a801"
BASE_PARENT: Final[str] = "f9122a4db5b4cbe27516cd03a8a86933fe9c2472"
PREREGISTRATION_COMMIT: Final[str] = (
    "679cebcfc8c86124be12c1a7ebbce2171735712d"
)
PREREGISTRATION_TREE: Final[str] = "f6880ecc0c6fa878b8c3798ae782183afa896113"
...
PREREGISTRATION_LITERAL_BYTES: Final[int] = 38_652

# Immutable rejected-predecessor evidence.  These values remain historical
# V3.12 pins and are deliberately not mechanically relabeled as V3.13.
V312_PREREGISTRATION_COMMIT: Final[str] = BASE_PARENT
V312_PREREGISTRATION_TREE: Final[str] = (
    "2136f781d804a9579ed78551d25d5d86c07a74d6"
)
V312_PREREGISTRATION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_12.md"
)
V312_PREREGISTRATION_GIT_BLOB_SHA1: Final[str] = (
    "7195936f87b66e34fb7e4119d5b9d4f6f949df74"
)
V312_PREREGISTRATION_LITERAL_SHA256: Final[str] = (
    "2bf92ba7f29836094c3204dd4a33f897eec316fa50272afab0ee8b98f15168ba"
)
V312_PREREGISTRATION_LITERAL_BYTES: Final[int] = 39_050
V312_REJECTION_COMMIT: Final[str] = BASE_COMMIT
V312_REJECTION_TREE: Final[str] = BASE_TREE
V312_REJECTION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_12_rejection.md"
)
V312_REJECTION_GIT_BLOB_SHA1: Final[str] = (
    "34e11f81e512cd2b8fa7641ef03c767c11c683f5"
)
V312_REJECTION_LITERAL_SHA256: Final[str] = (
    "fd06a7a1bcc9753207c6d74fd9cdd4984a5e1a6b683fc1d2f833a7360956eff0"
)
V312_REJECTION_LITERAL_BYTES: Final[int] = 4_849

# The consumed V3.10 implementation is source provenance only.  The V3.13
...
# never execution authority for v3.13.
...
# V3.13 nullable source/universe authority.  These are schemas and safe
# commitments only; no accession, filename, URL, body, or contact is public.
NULLABLE_SOURCE_RECORD_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-nullable-source-record-v1"
)
PRIVATE_SOURCE_IDENTITY_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-private-source-identity-v1"
)
COMPATIBILITY_MANIFEST_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-compatibility-manifest-v1"
)
NULLABLE_UNIVERSE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-nullable-universe-v1"
)
NULLABLE_UNIVERSE_SEMANTIC_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-nullable-universe-semantic-v1"
)
NULLABLE_CONTENT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-nullable-content-v1"
)
NULLABLE_UNIVERSE_EVENT_PROOF_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-nullable-universe-event-proof-v1"
)
BLINDED_MODEL_REQUEST_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-blinded-model-request-v1"
)
...
PRIVATE_NAMESPACE: Final[str] = "data/aapl_sec_gemma_lean_science_v3_13"
...
PUBLIC_EVIDENCE_ROOT: Final[str] = "e/aapl_sec_gemma_lean_science_v3_13"
...
CONTINUATION_PREREGISTRATION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_13_continuation.md"
)

IMPLEMENTATION_PRODUCTION_PATHS: Final[tuple[str, ...]] = (
    "agent_benchmark/sec_gemma_lean_science_v313_contract.py",
    "agent_benchmark/sec_gemma_lean_science_v313_bridge.py",
    "agent_benchmark/sec_gemma_lean_science_v313_journal.py",
    "agent_benchmark/sec_gemma_lean_science_v313_store.py",
    "agent_benchmark/sec_gemma_lean_science_v313_preflight.py",
    "agent_benchmark/sec_gemma_lean_science_v313_runner.py",
)
IMPLEMENTATION_TEST_PATHS: Final[tuple[str, ...]] = (
    "tests/test_sec_gemma_lean_science_v313_contract.py",
    "tests/test_sec_gemma_lean_science_v313_bridge.py",
    "tests/test_sec_gemma_lean_science_v313_journal.py",
    "tests/test_sec_gemma_lean_science_v313_store.py",
    "tests/test_sec_gemma_lean_science_v313_preflight.py",
    "tests/test_sec_gemma_lean_science_v313_runner.py",
)
...
LOCAL_PRODUCTION_CLOSURE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-local-production-closure-v1"
)
...
QUALIFICATION_PHASE_V313: Final[str] = "v313"
...
QUALIFICATION_LATEST_MIN_NODE_COUNT: Final[int] = 310
...
QUALIFICATION_COLLECTION_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-qualification-collection-v1"
)
QUALIFICATION_INTENT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-qualification-intent-v1"
)
QUALIFICATION_RESULT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-qualification-result-v1"
)
QUALIFICATION_PRIVATE_AGGREGATE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-qualification-private-aggregate-v1"
)
QUALIFICATION_PUBLIC_RECEIPT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-13-qualification-public-receipt-v1"
)
...
def _validate_json_value(value: Any, *, depth: int = 0) -> None:
    if depth > 128:
        _reject("v313_contract_json_depth")
    ...
    if isinstance(value, float):
        if not math.isfinite(value):
            _reject("v313_contract_json_nonfinite")
        return
    if isinstance(value, Mapping):
        for key, item in value.items():
            if not isinstance(key, str):
                _reject("v313_contract_json_key")
    ...
    if isinstance(value, (list, tuple)):
        for item in value:
            _validate_json_value(item, depth=depth + 1)
        return
    _reject("v313_contract_json_type")
...
def canonical_json_bytes(value: Any) -> bytes:
    ...
    try:
        ...
        raise ContractViolation("v313_contract_json_encoding") from exc
...
def sha256_bytes(value: bytes | bytearray | memoryview) -> str:
    ...
    if not isinstance(value, (bytes, bytearray, memoryview)):
        _reject("v313_contract_hash_input")
...
def add_self_sha256(
    ...
    *,
    ...
    if not isinstance(value, Mapping) or not isinstance(field, str) or not field:
        _reject("v313_contract_self_hash_shape")
    if field in value:
        _reject("v313_contract_self_hash_present")
...
def validate_self_sha256(
    ...
    *,
    ...
    if not _is_hex(observed, 64) or observed != canonical_sha256(detached):
        _reject("v313_contract_self_hash_mismatch")
...
def strip_exact_sha256_tag(value: Any) -> str:
    ...
    if match is None:
        _reject("v313_contract_tagged_sha256")
...
def validate_compatibility_record(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        ...
        code="v313_contract_compatibility_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v313_contract_compatibility_record_locator"
    )
    ...
    if (
        ...
        _reject("v313_contract_compatibility_record_identity")
    return item
...
def validate_compatibility_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        value, fields, code="v313_contract_compatibility_manifest_shape"
    )
    ...
    if (
        ...
        _reject("v313_contract_compatibility_manifest_identity")
    return item
...
def validate_nullable_universe_record(value: Any) -> dict[str, Any]:
    item = _strict_mapping(
        ...
        code="v313_contract_nullable_universe_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v313_contract_nullable_universe_record_locator"
    )
    accession = item["accession_number"]
    if (
        ...
        _reject("v313_contract_nullable_universe_record_identity")
    return item
...
def validate_nullable_universe_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        value, fields, code="v313_contract_nullable_universe_shape"
    )
    validate_self_sha256(item, field="universe_sha256")
    raw_records = item["records"]
    if type(raw_records) is not list:
        _reject("v313_contract_nullable_universe_records")
    ...
    if (
        ...
        _reject("v313_contract_nullable_universe_identity")
    return item
...
def validate_nullable_content_record(value: Any) -> dict[str, Any]:
    item = _strict_mapping(
        ...
        code="v313_contract_nullable_content_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v313_contract_nullable_content_record_locator"
    )
    accession = item["accession_number"]
    if (
        ...
        _reject("v313_contract_nullable_content_record_identity")
    return item
...
def validate_nullable_content_manifest(value: Any) -> dict[str, Any]:
    ...
    if (
        ...
        _reject("v313_contract_nullable_content_identity")
    return item
...
def _compatibility_record_for_successor(
    ...
    if compatibility is None:
        _reject("v313_contract_proof_compatibility_missing")
    ...
    for key, child in expected.items():
        if key in record and record[key] != child:
            _reject("v313_contract_proof_compatibility_mismatch")
    return item
...
def validate_nullable_universe_event_proof(
    ...
    *,
    ...
    if len(records) != DEVELOPMENT_DOCUMENT_COUNT:
        _reject("v313_contract_proof_compatibility_count")
    ...
    if (
        ...
        _reject("v313_contract_proof_compatibility_duplicate")
    item = _strict_mapping(
        value,
        frozenset(UNIVERSE_EVENT_PROOF_FIELDS),
        code="v313_contract_universe_event_proof_shape",
    )
    ...
    if universe_matches != [current] or content_matches != [current_content]:
        _reject("v313_contract_proof_membership")
    shared = (
        "accession_number",
        "form",
        "availability_session",
    ...
    if any(current[key] != current_content[key] for key in shared):
        _reject("v313_contract_proof_cross_manifest")
    ...
    if (
        ...
        _reject("v313_contract_universe_event_proof_identity")
    ...
    if expected_prior is None:
        if any(child is not None for child in prior_values):
            _reject("v313_contract_proof_prior")
    else:
...
def validate_blinded_model_request(
    ...
    *,
    ...
    """Validate the V3.13 wrapper after the complete proof has passed."""

    if not isinstance(value, Mapping) or set(value) != set(BLINDED_MODEL_REQUEST_FIELDS):
        _reject("v313_contract_blinded_request_shape")
    item = dict(value)
    if (
        not isinstance(proof, Mapping)
        or set(proof) != set(UNIVERSE_EVENT_PROOF_FIELDS)
    ):
        _reject("v313_contract_blinded_request_proof")
    ...
    if (
        ...
        _reject("v313_contract_blinded_request_identity")
    ...
    if _blinded_request_contains_private_identity(
        ...
        _reject("v313_contract_blinded_request_private_identity")
...
def build_nullable_model_slice(
    ...
    """Build the exact request-bytes-excluding V3.13 model-slice commitment."""
    ...
    if (
        ...
        _reject("v313_contract_model_slice_count")
    ...
    for request, proof in zip(model_requests, universe_event_proofs, strict=True):
        if not isinstance(request, Mapping) or not isinstance(proof, Mapping):
            _reject("v313_contract_model_slice_member")
        ...
        if (
            ...
            _reject("v313_contract_model_slice_order")
...
def validate_nullable_model_slice(value: Any) -> dict[str, Any]:
    if not isinstance(value, Mapping) or set(value) != {
        ...
        _reject("v313_contract_model_slice_shape")
    item = dict(value)
    ...
    if (
        ...
        _reject("v313_contract_model_slice_identity")
    return copy.deepcopy(item)
...
def project_science_manifest(source_manifest: Any) -> dict[str, Any]:
    ...
    if not isinstance(source_manifest, Mapping):
        _reject("v313_contract_science_source_shape")
    if any(key not in source_manifest for key in SCIENCE_PROJECTION_KEYS):
        _reject("v313_contract_science_source_keys")
    return {
...
def verify_frozen_science_projection(value: Any) -> dict[str, Any]:
    ...
    if not isinstance(value, Mapping) or set(value) != set(SCIENCE_PROJECTION_KEYS):
        _reject("v313_contract_science_projection_keys")
    ...
    if len(encoded) != SCIENCE_PROJECTION_BYTE_COUNT:
        _reject("v313_contract_science_projection_size")
    if sha256_bytes(encoded) != SCIENCE_PROJECTION_SHA256:
        _reject("v313_contract_science_projection_hash")
    return detached
...
def build_frozen_science_projection() -> dict[str, Any]:
    ...
    if predecessor_internal_sha256 != SCIENTIFIC_CONTRACT_INTERNAL_SHA256:
        _reject("v313_contract_science_parent_internal")
...
def build_v39_inherited_preregistration_pins() -> dict[str, Any]:
    """Return detached rejected-v3.9 provenance, never v3.13 authority."""
...
def build_v312_rejection_pins() -> dict[str, Any]:
    """Return immutable V3.12 rejection evidence, never V3.13 authority."""

    return {
        "preregistration": {
            "commit": V312_PREREGISTRATION_COMMIT,
            "tree": V312_PREREGISTRATION_TREE,
            "path": V312_PREREGISTRATION_PATH,
            "git_blob_sha1": V312_PREREGISTRATION_GIT_BLOB_SHA1,
            "literal_sha256": V312_PREREGISTRATION_LITERAL_SHA256,
            "literal_bytes": V312_PREREGISTRATION_LITERAL_BYTES,
        },
        "rejection": {
            "commit": V312_REJECTION_COMMIT,
            "tree": V312_REJECTION_TREE,
            "parent": V312_PREREGISTRATION_COMMIT,
            "path": V312_REJECTION_PATH,
            "git_blob_sha1": V312_REJECTION_GIT_BLOB_SHA1,
            "literal_sha256": V312_REJECTION_LITERAL_SHA256,
            "literal_bytes": V312_REJECTION_LITERAL_BYTES,
        },
        "phase2_node_count": 655,
        "phase2_case_sensitive_unique_node_count": 655,
        "phase2_duplicate_node_count": 0,
        "phase2_ordered_node_list_sha256": (
            "1de8cc183af68c089aa5616f5e51405abda34382ff15e73123f5cd3c0dfea83c"
        ),
...
def build_qualification_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "latest": {
            "phase": QUALIFICATION_PHASE_V313,
...
def validate_effect_counts(value: Any, *, route: str) -> dict[str, int]:
    ...
    if route not in budgets:
        _reject("v313_contract_effect_route")
    if not isinstance(value, Mapping) or set(value) != set(EFFECT_COUNT_KEYS):
        _reject("v313_contract_effect_keys")
    if any(type(item) is not int or item < 0 for item in value.values()):
        _reject("v313_contract_effect_type")
    observed = dict(value)
    if observed != budgets[route]:
        _reject("v313_contract_effect_counts")
...
def projected_pilot_ns(durations_ns: Any) -> int:
    ...
    if (
        ...
        _reject("v313_contract_pilot_durations")
...
def validate_local_production_closure_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v313_contract_closure_shape")
    paths = item["paths"]
    if (
        ...
        _reject("v313_contract_closure_identity")
    ...
    if (
        ...
        _reject("v313_contract_closure_manifest")
    return item
...
def validate_local_import_paths(value: Any) -> tuple[str, ...]:
    ...
    if (
        ...
        _reject("v313_contract_local_import_shape")
    paths = tuple(value)
    if len(paths) != len(set(paths)):
        _reject("v313_contract_local_import_duplicate")
    allowed = frozenset(LOCAL_IMPORT_ALLOWED_PATHS)
    if any(path not in allowed for path in paths):
        _reject("v313_contract_local_import_outside_closure")
    return paths
...
def validate_preregistration_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v313_contract_prereg_shape")
    expected = {
        "branch": BRANCH_NAME,
    ...
    if item != expected:
        _reject("v313_contract_prereg_ancestry")
    return item
...
def validate_implementation_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v313_contract_impl_shape")
    commit = item["commit"]
    if (
...
def validate_preflight_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v313_contract_preflight_shape")
    commit = item["commit"]
    ...
    if (
        ...
        _reject("v313_contract_preflight_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {PREFLIGHT_ARTIFACT_PATH: "A"},
        code="v313_contract_preflight_delta",
    )
    return item
...
def validate_pause_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v313_contract_pause_shape")
    commit = item["commit"]
    if (
        item["branch"] != BRANCH_NAME
        or not _is_hex(commit, 40)
        ...
        _reject("v313_contract_pause_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {PAUSE_ARTIFACT_PATH: "A"},
        code="v313_contract_pause_delta",
    )
    return item
...
def validate_continuation_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v313_contract_continue_shape")
    commit = item["commit"]
    if (
        item["branch"] != BRANCH_NAME
        or not _is_hex(commit, 40)
        ...
        _reject("v313_contract_continue_ancestry")
    _validate_changed_paths(
        item["changed_paths_from_pause"],
        {CONTINUATION_PREREGISTRATION_PATH: "A"},
        code="v313_contract_continue_delta",
    )
    _validate_changed_paths(
        ...
        code="v313_contract_continue_cumulative_delta",
    )
    return item
...
def validate_result_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v313_contract_result_shape")
    route = item["route"]
    ...
    if (
        ...
        _reject("v313_contract_result_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {RESULT_ARTIFACT_PATH: "A", COMPARISON_PATH: "M"},
        code="v313_contract_result_delta",
    )
    return item
...
def _build_unsigned_contract_manifest() -> dict[str, Any]:
    ...
    if len(development_gates) != 22:
        _reject("v313_contract_development_gate_count")
    return {
        ...
        "v312_rejection_authority": build_v312_rejection_pins(),
...
def build_contract_manifest() -> dict[str, Any]:
    ...
    if observed != CONTRACT_MANIFEST_SHA256:
        _reject("v313_contract_manifest_literal")
    return {**unsigned, "contract_manifest_sha256": observed}


def validate_contract_manifest(value: Any) -> dict[str, Any]:
    """Accept only the exact self-hashed v3.13 manifest."""

    if not isinstance(value, Mapping):
        _reject("v313_contract_manifest_shape")
    ...
    if canonical_json_bytes(candidate) != canonical_json_bytes(expected):
        _reject("v313_contract_manifest_mismatch")
