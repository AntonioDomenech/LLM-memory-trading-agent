"""Pure, fail-closed contract for the v3.14 SEC-to-science bridge.
...
CONTRACT_VERSION: Final[str] = "aapl-sec-gemma-lean-science-v3-14"
CONTRACT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-contract-v1"
)
BRANCH_NAME: Final[str] = "codex/aapl-sec-gemma-lean-science-v3-14"
...
BASE_COMMIT: Final[str] = "efe541664c95863631fec470fdb11ea2fef6b599"
BASE_TREE: Final[str] = "2fa9a5c1afec001f8046d87a0a26ef60b677d458"
BASE_PARENT: Final[str] = "2f996bc963807f4a901676589b0b66d93855c184"
PREREGISTRATION_COMMIT: Final[str] = (
    "9f9598e1100e897f57dbbb2df95adeb184e6ca08"
)
PREREGISTRATION_TREE: Final[str] = "46870361d13dc5ee712eda367ae42699f1eea9da"
...
PREREGISTRATION_LITERAL_BYTES: Final[int] = 21_988

# Immutable rejected-predecessor evidence.  These values remain historical
# V3.13 pins and are deliberately not mechanically relabeled as V3.14.
V313_PREREGISTRATION_COMMIT: Final[str] = (
    "679cebcfc8c86124be12c1a7ebbce2171735712d"
)
V313_PREREGISTRATION_TREE: Final[str] = (
    "f6880ecc0c6fa878b8c3798ae782183afa896113"
)
V313_PREREGISTRATION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_13.md"
)
V313_PREREGISTRATION_GIT_BLOB_SHA1: Final[str] = (
    "8c2a32ae424d820ec73d2d053b588c1e3dda4a96"
)
V313_PREREGISTRATION_LITERAL_SHA256: Final[str] = (
    "600806541de00846e13f2a1b6a7b4b0bdff09e8d8d3e0432635bfc9b3dab00b2"
)
V313_PREREGISTRATION_LITERAL_BYTES: Final[int] = 38_652
V313_IMPLEMENTATION_COMMIT: Final[str] = BASE_PARENT
V313_IMPLEMENTATION_TREE: Final[str] = (
    "7fe69f3cd715e27a6c3eb09fed402419591ba118"
)
V313_REJECTION_COMMIT: Final[str] = BASE_COMMIT
V313_REJECTION_TREE: Final[str] = BASE_TREE
V313_REJECTION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_13_rejection.md"
)
V313_REJECTION_GIT_BLOB_SHA1: Final[str] = (
    "ce17dea05369755a45df2c91dede6d35ce04ecc8"
)
V313_REJECTION_LITERAL_SHA256: Final[str] = (
    "731b9cde5249faa60f8f32dba6c6ececfafddb4e2ff680a42e64293ca77f4999"
)
V313_REJECTION_LITERAL_BYTES: Final[int] = 4_932

# The consumed V3.10 implementation is source provenance only.  The V3.14
...
# never execution authority for v3.14.
...
# V3.14 nullable source/universe authority.  These are schemas and safe
# commitments only; no accession, filename, URL, body, or contact is public.
NULLABLE_SOURCE_RECORD_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-nullable-source-record-v1"
)
PRIVATE_SOURCE_IDENTITY_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-private-source-identity-v1"
)
COMPATIBILITY_MANIFEST_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-compatibility-manifest-v1"
)
NULLABLE_UNIVERSE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-nullable-universe-v1"
)
NULLABLE_UNIVERSE_SEMANTIC_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-nullable-universe-semantic-v1"
)
NULLABLE_CONTENT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-nullable-content-v1"
)
NULLABLE_UNIVERSE_EVENT_PROOF_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-nullable-universe-event-proof-v1"
)
BLINDED_MODEL_REQUEST_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-blinded-model-request-v1"
)
...
DEVELOPMENT_ATTEMPT_ID: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-development-001"
)
PRIVATE_NAMESPACE: Final[str] = "data/aapl_sec_gemma_lean_science_v3_14"
...
PUBLIC_EVIDENCE_ROOT: Final[str] = "e/aapl_sec_gemma_lean_science_v3_14"
...
CONTINUATION_PREREGISTRATION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_14_continuation.md"
)

IMPLEMENTATION_PRODUCTION_PATHS: Final[tuple[str, ...]] = (
    "agent_benchmark/sec_gemma_lean_science_v314_contract.py",
    "agent_benchmark/sec_gemma_lean_science_v314_bridge.py",
    "agent_benchmark/sec_gemma_lean_science_v314_journal.py",
    "agent_benchmark/sec_gemma_lean_science_v314_store.py",
    "agent_benchmark/sec_gemma_lean_science_v314_preflight.py",
    "agent_benchmark/sec_gemma_lean_science_v314_runner.py",
)
IMPLEMENTATION_TEST_PATHS: Final[tuple[str, ...]] = (
    "tests/test_sec_gemma_lean_science_v314_contract.py",
    "tests/test_sec_gemma_lean_science_v314_bridge.py",
    "tests/test_sec_gemma_lean_science_v314_journal.py",
    "tests/test_sec_gemma_lean_science_v314_store.py",
    "tests/test_sec_gemma_lean_science_v314_preflight.py",
    "tests/test_sec_gemma_lean_science_v314_runner.py",
)
...
LOCAL_PRODUCTION_CLOSURE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-local-production-closure-v1"
)
...
LOCAL_PRODUCTION_CLOSURE_MANIFEST_SHA256: Final[str] = (
    "78fb70cea3c66a45b9cc1d3e76e8815a75b346b29cbcbdacf83889652d42c74b"
)
...
QUALIFICATION_PHASE_V314: Final[str] = "v314"
...
QUALIFICATION_LATEST_MIN_NODE_COUNT: Final[int] = 323
...
QUALIFICATION_COLLECTION_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-qualification-collection-v1"
)
QUALIFICATION_INTENT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-qualification-intent-v1"
)
QUALIFICATION_RESULT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-qualification-result-v1"
)
QUALIFICATION_PRIVATE_AGGREGATE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-qualification-private-aggregate-v1"
)
QUALIFICATION_PUBLIC_RECEIPT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-14-qualification-public-receipt-v1"
)
...
def _validate_json_value(value: Any, *, depth: int = 0) -> None:
    if depth > 128:
        _reject("v314_contract_json_depth")
    ...
    if isinstance(value, float):
        if not math.isfinite(value):
            _reject("v314_contract_json_nonfinite")
        return
    if isinstance(value, Mapping):
        for key, item in value.items():
            if not isinstance(key, str):
                _reject("v314_contract_json_key")
    ...
    if isinstance(value, (list, tuple)):
        for item in value:
            _validate_json_value(item, depth=depth + 1)
        return
    _reject("v314_contract_json_type")
...
def canonical_json_bytes(value: Any) -> bytes:
    ...
    try:
        ...
        raise ContractViolation("v314_contract_json_encoding") from exc
...
def sha256_bytes(value: bytes | bytearray | memoryview) -> str:
    ...
    if not isinstance(value, (bytes, bytearray, memoryview)):
        _reject("v314_contract_hash_input")
...
def add_self_sha256(
    ...
    *,
    ...
    if not isinstance(value, Mapping) or not isinstance(field, str) or not field:
        _reject("v314_contract_self_hash_shape")
    if field in value:
        _reject("v314_contract_self_hash_present")
...
def validate_self_sha256(
    ...
    *,
    ...
    if not _is_hex(observed, 64) or observed != canonical_sha256(detached):
        _reject("v314_contract_self_hash_mismatch")
...
def strip_exact_sha256_tag(value: Any) -> str:
    ...
    if match is None:
        _reject("v314_contract_tagged_sha256")
...
def validate_compatibility_record(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        ...
        code="v314_contract_compatibility_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v314_contract_compatibility_record_locator"
    )
    ...
    if (
        ...
        _reject("v314_contract_compatibility_record_identity")
    return item
...
def validate_compatibility_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        value, fields, code="v314_contract_compatibility_manifest_shape"
    )
    ...
    if (
        ...
        _reject("v314_contract_compatibility_manifest_identity")
    return item
...
def validate_nullable_universe_record(value: Any) -> dict[str, Any]:
    item = _strict_mapping(
        ...
        code="v314_contract_nullable_universe_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v314_contract_nullable_universe_record_locator"
    )
    accession = item["accession_number"]
    if (
        ...
        _reject("v314_contract_nullable_universe_record_identity")
    return item
...
def validate_nullable_universe_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        value, fields, code="v314_contract_nullable_universe_shape"
    )
    validate_self_sha256(item, field="universe_sha256")
    raw_records = item["records"]
    if type(raw_records) is not list:
        _reject("v314_contract_nullable_universe_records")
    ...
    if (
        ...
        _reject("v314_contract_nullable_universe_identity")
    return item
...
def validate_nullable_content_record(value: Any) -> dict[str, Any]:
    item = _strict_mapping(
        ...
        code="v314_contract_nullable_content_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v314_contract_nullable_content_record_locator"
    )
    accession = item["accession_number"]
    if (
        ...
        _reject("v314_contract_nullable_content_record_identity")
    return item
...
def validate_nullable_content_manifest(value: Any) -> dict[str, Any]:
    ...
    if (
        ...
        _reject("v314_contract_nullable_content_identity")
    return item
...
def _compatibility_record_for_successor(
    ...
    if compatibility is None:
        _reject("v314_contract_proof_compatibility_missing")
    ...
    for key, child in expected.items():
        if key in record and record[key] != child:
            _reject("v314_contract_proof_compatibility_mismatch")
    return item
...
def validate_nullable_universe_event_proof(
    ...
    *,
    ...
    if len(records) != DEVELOPMENT_DOCUMENT_COUNT:
        _reject("v314_contract_proof_compatibility_count")
    ...
    if (
        ...
        _reject("v314_contract_proof_compatibility_duplicate")
    item = _strict_mapping(
        value,
        frozenset(UNIVERSE_EVENT_PROOF_FIELDS),
        code="v314_contract_universe_event_proof_shape",
    )
    ...
    if universe_matches != [current] or content_matches != [current_content]:
        _reject("v314_contract_proof_membership")
    shared = (
        "accession_number",
        "form",
        "availability_session",
    ...
    if any(current[key] != current_content[key] for key in shared):
        _reject("v314_contract_proof_cross_manifest")
    ...
    if (
        ...
        _reject("v314_contract_universe_event_proof_identity")
    ...
    if expected_prior is None:
        if any(child is not None for child in prior_values):
            _reject("v314_contract_proof_prior")
    else:
...
def validate_blinded_model_request(
    ...
    *,
    ...
    """Validate the V3.14 wrapper after the complete proof has passed."""

    if not isinstance(value, Mapping) or set(value) != set(BLINDED_MODEL_REQUEST_FIELDS):
        _reject("v314_contract_blinded_request_shape")
    item = dict(value)
    if (
        not isinstance(proof, Mapping)
        or set(proof) != set(UNIVERSE_EVENT_PROOF_FIELDS)
    ):
        _reject("v314_contract_blinded_request_proof")
    ...
    if (
        ...
        _reject("v314_contract_blinded_request_identity")
    ...
    if _blinded_request_contains_private_identity(
        ...
        _reject("v314_contract_blinded_request_private_identity")
...
def build_nullable_model_slice(
    ...
    """Build the exact request-bytes-excluding V3.14 model-slice commitment."""
    ...
    if (
        ...
        _reject("v314_contract_model_slice_count")
    ...
    for request, proof in zip(model_requests, universe_event_proofs, strict=True):
        if not isinstance(request, Mapping) or not isinstance(proof, Mapping):
            _reject("v314_contract_model_slice_member")
        ...
        if (
            ...
            _reject("v314_contract_model_slice_order")
...
def validate_nullable_model_slice(value: Any) -> dict[str, Any]:
    if not isinstance(value, Mapping) or set(value) != {
        ...
        _reject("v314_contract_model_slice_shape")
    item = dict(value)
    ...
    if (
        ...
        _reject("v314_contract_model_slice_identity")
    return copy.deepcopy(item)
...
def project_science_manifest(source_manifest: Any) -> dict[str, Any]:
    ...
    if not isinstance(source_manifest, Mapping):
        _reject("v314_contract_science_source_shape")
    if any(key not in source_manifest for key in SCIENCE_PROJECTION_KEYS):
        _reject("v314_contract_science_source_keys")
    return {
...
def verify_frozen_science_projection(value: Any) -> dict[str, Any]:
    ...
    if not isinstance(value, Mapping) or set(value) != set(SCIENCE_PROJECTION_KEYS):
        _reject("v314_contract_science_projection_keys")
    ...
    if len(encoded) != SCIENCE_PROJECTION_BYTE_COUNT:
        _reject("v314_contract_science_projection_size")
    if sha256_bytes(encoded) != SCIENCE_PROJECTION_SHA256:
        _reject("v314_contract_science_projection_hash")
    return detached
...
def build_frozen_science_projection() -> dict[str, Any]:
    ...
    if predecessor_internal_sha256 != SCIENTIFIC_CONTRACT_INTERNAL_SHA256:
        _reject("v314_contract_science_parent_internal")
...
def build_v39_inherited_preregistration_pins() -> dict[str, Any]:
    """Return detached rejected-v3.9 provenance, never v3.14 authority."""
...
def build_v313_rejection_pins() -> dict[str, Any]:
    """Return immutable V3.13 rejection evidence, never V3.14 authority."""

    return {
        "preregistration": {
            "commit": V313_PREREGISTRATION_COMMIT,
            "tree": V313_PREREGISTRATION_TREE,
            "path": V313_PREREGISTRATION_PATH,
            "git_blob_sha1": V313_PREREGISTRATION_GIT_BLOB_SHA1,
            "literal_sha256": V313_PREREGISTRATION_LITERAL_SHA256,
            "literal_bytes": V313_PREREGISTRATION_LITERAL_BYTES,
        },
        "implementation": {
            "commit": V313_IMPLEMENTATION_COMMIT,
            "tree": V313_IMPLEMENTATION_TREE,
            "parent": V313_PREREGISTRATION_COMMIT,
        },
        "rejection": {
            "commit": V313_REJECTION_COMMIT,
            "tree": V313_REJECTION_TREE,
            "parent": V313_IMPLEMENTATION_COMMIT,
            "path": V313_REJECTION_PATH,
            "git_blob_sha1": V313_REJECTION_GIT_BLOB_SHA1,
            "literal_sha256": V313_REJECTION_LITERAL_SHA256,
            "literal_bytes": V313_REJECTION_LITERAL_BYTES,
        },
        "phase1_node_count": 322,
        "phase1_case_sensitive_unique_node_count": 322,
        "phase1_duplicate_node_count": 0,
        "phase1_required_node_count": 21,
        "official_qualification_run_count": 0,
...
def build_qualification_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "latest": {
            "phase": QUALIFICATION_PHASE_V314,
...
def validate_effect_counts(value: Any, *, route: str) -> dict[str, int]:
    ...
    if route not in budgets:
        _reject("v314_contract_effect_route")
    if not isinstance(value, Mapping) or set(value) != set(EFFECT_COUNT_KEYS):
        _reject("v314_contract_effect_keys")
    if any(type(item) is not int or item < 0 for item in value.values()):
        _reject("v314_contract_effect_type")
    observed = dict(value)
    if observed != budgets[route]:
        _reject("v314_contract_effect_counts")
...
def projected_pilot_ns(durations_ns: Any) -> int:
    ...
    if (
        ...
        _reject("v314_contract_pilot_durations")
...
def validate_local_production_closure_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v314_contract_closure_shape")
    paths = item["paths"]
    if (
        ...
        _reject("v314_contract_closure_identity")
    ...
    if (
        ...
        _reject("v314_contract_closure_manifest")
    return item
...
def validate_local_import_paths(value: Any) -> tuple[str, ...]:
    ...
    if (
        ...
        _reject("v314_contract_local_import_shape")
    paths = tuple(value)
    if len(paths) != len(set(paths)):
        _reject("v314_contract_local_import_duplicate")
    allowed = frozenset(LOCAL_IMPORT_ALLOWED_PATHS)
    if any(path not in allowed for path in paths):
        _reject("v314_contract_local_import_outside_closure")
    return paths
...
def validate_preregistration_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v314_contract_prereg_shape")
    expected = {
        "branch": BRANCH_NAME,
    ...
    if item != expected:
        _reject("v314_contract_prereg_ancestry")
    return item
...
def validate_implementation_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v314_contract_impl_shape")
    commit = item["commit"]
    if (
...
def validate_preflight_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v314_contract_preflight_shape")
    commit = item["commit"]
    ...
    if (
        ...
        _reject("v314_contract_preflight_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {PREFLIGHT_ARTIFACT_PATH: "A"},
        code="v314_contract_preflight_delta",
    )
    return item
...
def validate_pause_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v314_contract_pause_shape")
    commit = item["commit"]
    if (
        item["branch"] != BRANCH_NAME
        or not _is_hex(commit, 40)
        ...
        _reject("v314_contract_pause_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {PAUSE_ARTIFACT_PATH: "A"},
        code="v314_contract_pause_delta",
    )
    return item
...
def validate_continuation_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v314_contract_continue_shape")
    commit = item["commit"]
    if (
        item["branch"] != BRANCH_NAME
        or not _is_hex(commit, 40)
        ...
        _reject("v314_contract_continue_ancestry")
    _validate_changed_paths(
        item["changed_paths_from_pause"],
        {CONTINUATION_PREREGISTRATION_PATH: "A"},
        code="v314_contract_continue_delta",
    )
    _validate_changed_paths(
        ...
        code="v314_contract_continue_cumulative_delta",
    )
    return item
...
def validate_result_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v314_contract_result_shape")
    route = item["route"]
    ...
    if (
        ...
        _reject("v314_contract_result_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {RESULT_ARTIFACT_PATH: "A", COMPARISON_PATH: "M"},
        code="v314_contract_result_delta",
    )
    return item
...
def _build_unsigned_contract_manifest() -> dict[str, Any]:
    ...
    if len(development_gates) != 22:
        _reject("v314_contract_development_gate_count")
    return {
        ...
        "v313_rejection_authority": build_v313_rejection_pins(),
...
CONTRACT_MANIFEST_SHA256: Final[str] = (
    "218d728c5f594696eacf19b926ea5b14a4317ab03b118e58d0d779be76ac1dd0"
)
...
def build_contract_manifest() -> dict[str, Any]:
    ...
    if observed != CONTRACT_MANIFEST_SHA256:
        _reject("v314_contract_manifest_literal")
    return {**unsigned, "contract_manifest_sha256": observed}


def validate_contract_manifest(value: Any) -> dict[str, Any]:
    """Accept only the exact self-hashed v3.14 manifest."""

    if not isinstance(value, Mapping):
        _reject("v314_contract_manifest_shape")
    ...
    if canonical_json_bytes(candidate) != canonical_json_bytes(expected):
        _reject("v314_contract_manifest_mismatch")
