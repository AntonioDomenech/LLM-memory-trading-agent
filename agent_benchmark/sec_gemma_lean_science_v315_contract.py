"""Pure, fail-closed contract for the v3.15 SEC-to-science bridge.
...
CONTRACT_VERSION: Final[str] = "aapl-sec-gemma-lean-science-v3-15"
CONTRACT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-contract-v1"
)
BRANCH_NAME: Final[str] = "codex/aapl-sec-gemma-lean-science-v3-15"
...
BASE_COMMIT: Final[str] = "3e813577f1aab4ae80d0f5f59362a46320c818fb"
BASE_TREE: Final[str] = "90d4e6681acb81fc11f5abf9860df331923a907d"
BASE_PARENT: Final[str] = "a6b5346e8bf6edec66fad38d35392a6d0a2c513b"
PREREGISTRATION_COMMIT: Final[str] = (
    "3955520674a3b6ccfa29cf9fc6593e110917e437"
)
PREREGISTRATION_TREE: Final[str] = "c07f5893b235b145914cb115e1888fb360d59b34"
...
PREREGISTRATION_LITERAL_BYTES: Final[int] = 24_926

# Immutable consumed-predecessor evidence.  These values preserve the complete
# V3.14 P/I/F/X failure topology and are never V3.15 execution authority.
V314_PREREGISTRATION_COMMIT: Final[str] = (
    "9f9598e1100e897f57dbbb2df95adeb184e6ca08"
)
V314_PREREGISTRATION_TREE: Final[str] = (
    "46870361d13dc5ee712eda367ae42699f1eea9da"
)
V314_PREREGISTRATION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_14.md"
)
V314_PREREGISTRATION_GIT_BLOB_SHA1: Final[str] = (
    "f7776b26053040dffc5848ffd5ec84a6f7d9f7d2"
)
V314_PREREGISTRATION_LITERAL_SHA256: Final[str] = (
    "0a1f3026aae942dca69dca2408df9f8ebfc59d3761581878fac8adac86d12b96"
)
V314_PREREGISTRATION_LITERAL_BYTES: Final[int] = 21_988
V314_IMPLEMENTATION_COMMIT: Final[str] = (
    "c4bdc39275e1bf29425bdcad5e9ccd83f0dfafa5"
)
V314_IMPLEMENTATION_TREE: Final[str] = (
    "48c1c5ba9e8bfc02245cb8ea32b7dd22f1019323"
)
V314_PREFLIGHT_FAILURE_COMMIT: Final[str] = BASE_PARENT
V314_PREFLIGHT_FAILURE_TREE: Final[str] = (
    "328306c4f853a4d036ea62fbaad3f964f7e4a37c"
)
V314_PREFLIGHT_FAILURE_PATH: Final[str] = (
    "e/aapl_sec_gemma_lean_science_v3_14/DEVELOPMENT_PREFLIGHT.json"
)
V314_PREFLIGHT_FAILURE_GIT_BLOB_SHA1: Final[str] = (
    "a8c6994eafb2d21a57c63776fbef813a084edf39"
)
V314_PREFLIGHT_FAILURE_LITERAL_SHA256: Final[str] = (
    "48bbd08e7cd442f97d0ead4845d0006ea7b074dbcacf228db28cf64bd993b8db"
)
V314_PREFLIGHT_FAILURE_LITERAL_BYTES: Final[int] = 622
V314_PREFLIGHT_FAILURE_INTERNAL_SHA256: Final[str] = (
    "ba7ec4cef562521304188dbf94eacb6acc1c179a48d6a211ba516ace8ad07e63"
)
V314_REJECTION_COMMIT: Final[str] = BASE_COMMIT
V314_REJECTION_TREE: Final[str] = BASE_TREE
V314_REJECTION_PATH: Final[str] = "e/APPROACH_COMPARISON.md"
V314_REJECTION_GIT_BLOB_SHA1: Final[str] = (
    "34cc452f1a4fd97422f717e5e9ef08ed55ce8c93"
)
V314_REJECTION_LITERAL_SHA256: Final[str] = (
    "cfcaa3d8932427b842381a7072f35bf94010cb44cae97f883c520186b7a30250"
)
V314_REJECTION_LITERAL_BYTES: Final[int] = 33_079

# The consumed V3.10 implementation is source provenance only.  The V3.15
...
# never execution authority for v3.15.
...
# V3.15 nullable source/universe authority.  These are schemas and safe
# commitments only; no accession, filename, URL, body, or contact is public.
NULLABLE_SOURCE_RECORD_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-nullable-source-record-v1"
)
...
COMPATIBILITY_MANIFEST_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-compatibility-manifest-v1"
)
NULLABLE_UNIVERSE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-nullable-universe-v1"
)
NULLABLE_UNIVERSE_SEMANTIC_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-nullable-universe-semantic-v1"
)
NULLABLE_CONTENT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-nullable-content-v1"
)
NULLABLE_UNIVERSE_EVENT_PROOF_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-nullable-universe-event-proof-v1"
)
BLINDED_MODEL_REQUEST_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-blinded-model-request-v1"
)
...
PRIVATE_NAMESPACE: Final[str] = "data/aapl_sec_gemma_lean_science_v3_15"
...
PUBLIC_EVIDENCE_ROOT: Final[str] = "e/aapl_sec_gemma_lean_science_v3_15"
...
CONTINUATION_PREREGISTRATION_PATH: Final[str] = (
    "docs/aapl_sec_gemma_lean_science_v3_15_continuation.md"
)

IMPLEMENTATION_PRODUCTION_PATHS: Final[tuple[str, ...]] = (
    "agent_benchmark/sec_gemma_lean_science_v315_contract.py",
    "agent_benchmark/sec_gemma_lean_science_v315_bridge.py",
    "agent_benchmark/sec_gemma_lean_science_v315_journal.py",
    "agent_benchmark/sec_gemma_lean_science_v315_store.py",
    "agent_benchmark/sec_gemma_lean_science_v315_preflight.py",
    "agent_benchmark/sec_gemma_lean_science_v315_runner.py",
)
IMPLEMENTATION_TEST_PATHS: Final[tuple[str, ...]] = (
    "tests/test_sec_gemma_lean_science_v315_contract.py",
    "tests/test_sec_gemma_lean_science_v315_bridge.py",
    "tests/test_sec_gemma_lean_science_v315_journal.py",
    "tests/test_sec_gemma_lean_science_v315_store.py",
    "tests/test_sec_gemma_lean_science_v315_preflight.py",
    "tests/test_sec_gemma_lean_science_v315_runner.py",
)
...
LOCAL_PRODUCTION_CLOSURE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-local-production-closure-v1"
)
...
LOCAL_PRODUCTION_CLOSURE_MANIFEST_SHA256: Final[str] = (
    "984b70377ca5d294e62697fdb470a33811e6cbb568cbbe31b680909b56ad9ca3"
)
...
QUALIFICATION_PHASE_V315: Final[str] = "v315"
...
QUALIFICATION_BOOTSTRAP_BYTES: Final[int] = 3_999
...
QUALIFICATION_LATEST_MIN_NODE_COUNT: Final[int] = 324
...
QUALIFICATION_COLLECTION_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-qualification-collection-v1"
)
QUALIFICATION_INTENT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-qualification-intent-v1"
)
QUALIFICATION_RESULT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-qualification-result-v1"
)
QUALIFICATION_PRIVATE_AGGREGATE_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-qualification-private-aggregate-v1"
)
QUALIFICATION_PUBLIC_RECEIPT_SCHEMA_VERSION: Final[str] = (
    "aapl-sec-gemma-lean-science-v3-15-qualification-public-receipt-v1"
)
...
def _validate_json_value(value: Any, *, depth: int = 0) -> None:
    if depth > 128:
        _reject("v315_contract_json_depth")
    ...
    if isinstance(value, float):
        if not math.isfinite(value):
            _reject("v315_contract_json_nonfinite")
        return
    if isinstance(value, Mapping):
        for key, item in value.items():
            if not isinstance(key, str):
                _reject("v315_contract_json_key")
    ...
    if isinstance(value, (list, tuple)):
        for item in value:
            _validate_json_value(item, depth=depth + 1)
        return
    _reject("v315_contract_json_type")
...
def canonical_json_bytes(value: Any) -> bytes:
    ...
    try:
        ...
        raise ContractViolation("v315_contract_json_encoding") from exc
...
def sha256_bytes(value: bytes | bytearray | memoryview) -> str:
    ...
    if not isinstance(value, (bytes, bytearray, memoryview)):
        _reject("v315_contract_hash_input")
...
def add_self_sha256(
    ...
    *,
    ...
    if not isinstance(value, Mapping) or not isinstance(field, str) or not field:
        _reject("v315_contract_self_hash_shape")
    if field in value:
        _reject("v315_contract_self_hash_present")
...
def validate_self_sha256(
    ...
    *,
    ...
    if not _is_hex(observed, 64) or observed != canonical_sha256(detached):
        _reject("v315_contract_self_hash_mismatch")
...
def strip_exact_sha256_tag(value: Any) -> str:
    ...
    if match is None:
        _reject("v315_contract_tagged_sha256")
...
def validate_compatibility_record(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        ...
        code="v315_contract_compatibility_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v315_contract_compatibility_record_locator"
    )
    ...
    if (
        ...
        _reject("v315_contract_compatibility_record_identity")
    return item
...
def validate_compatibility_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        value, fields, code="v315_contract_compatibility_manifest_shape"
    )
    ...
    if (
        ...
        _reject("v315_contract_compatibility_manifest_identity")
    return item
...
def validate_nullable_universe_record(value: Any) -> dict[str, Any]:
    item = _strict_mapping(
        ...
        code="v315_contract_nullable_universe_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v315_contract_nullable_universe_record_locator"
    )
    accession = item["accession_number"]
    if (
        ...
        _reject("v315_contract_nullable_universe_record_identity")
    return item
...
def validate_nullable_universe_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(
        value, fields, code="v315_contract_nullable_universe_shape"
    )
    validate_self_sha256(item, field="universe_sha256")
    raw_records = item["records"]
    if type(raw_records) is not list:
        _reject("v315_contract_nullable_universe_records")
    ...
    if (
        ...
        _reject("v315_contract_nullable_universe_identity")
    return item
...
def validate_nullable_content_record(value: Any) -> dict[str, Any]:
    item = _strict_mapping(
        ...
        code="v315_contract_nullable_content_record_shape",
    )
    _validate_nullable_locator_fields(
        item, code="v315_contract_nullable_content_record_locator"
    )
    accession = item["accession_number"]
    if (
        ...
        _reject("v315_contract_nullable_content_record_identity")
    return item
...
def validate_nullable_content_manifest(value: Any) -> dict[str, Any]:
    ...
    if (
        ...
        _reject("v315_contract_nullable_content_identity")
    return item
...
def _compatibility_record_for_successor(
    ...
    if compatibility is None:
        _reject("v315_contract_proof_compatibility_missing")
    ...
    for key, child in expected.items():
        if key in record and record[key] != child:
            _reject("v315_contract_proof_compatibility_mismatch")
    return item
...
def validate_nullable_universe_event_proof(
    ...
    *,
    ...
    if len(records) != DEVELOPMENT_DOCUMENT_COUNT:
        _reject("v315_contract_proof_compatibility_count")
    ...
    if (
        ...
        _reject("v315_contract_proof_compatibility_duplicate")
    item = _strict_mapping(
        value,
        frozenset(UNIVERSE_EVENT_PROOF_FIELDS),
        code="v315_contract_universe_event_proof_shape",
    )
    ...
    if universe_matches != [current] or content_matches != [current_content]:
        _reject("v315_contract_proof_membership")
    shared = (
        "accession_number",
        "form",
        "availability_session",
    ...
    if any(current[key] != current_content[key] for key in shared):
        _reject("v315_contract_proof_cross_manifest")
    ...
    if (
        ...
        _reject("v315_contract_universe_event_proof_identity")
    ...
    if expected_prior is None:
        if any(child is not None for child in prior_values):
            _reject("v315_contract_proof_prior")
    else:
...
def validate_blinded_model_request(
    ...
    *,
    ...
    """Validate the V3.15 wrapper after the complete proof has passed."""

    if not isinstance(value, Mapping) or set(value) != set(BLINDED_MODEL_REQUEST_FIELDS):
        _reject("v315_contract_blinded_request_shape")
    item = dict(value)
    if (
        not isinstance(proof, Mapping)
        or set(proof) != set(UNIVERSE_EVENT_PROOF_FIELDS)
    ):
        _reject("v315_contract_blinded_request_proof")
    ...
    if (
        ...
        _reject("v315_contract_blinded_request_identity")
    ...
    if _blinded_request_contains_private_identity(
        ...
        _reject("v315_contract_blinded_request_private_identity")
...
def build_nullable_model_slice(
    ...
    """Build the exact request-bytes-excluding V3.15 model-slice commitment."""
    ...
    if (
        ...
        _reject("v315_contract_model_slice_count")
    ...
    for request, proof in zip(model_requests, universe_event_proofs, strict=True):
        if not isinstance(request, Mapping) or not isinstance(proof, Mapping):
            _reject("v315_contract_model_slice_member")
        ...
        if (
            ...
            _reject("v315_contract_model_slice_order")
...
def validate_nullable_model_slice(value: Any) -> dict[str, Any]:
    if not isinstance(value, Mapping) or set(value) != {
        ...
        _reject("v315_contract_model_slice_shape")
    item = dict(value)
    ...
    if (
        ...
        _reject("v315_contract_model_slice_identity")
    return copy.deepcopy(item)
...
def project_science_manifest(source_manifest: Any) -> dict[str, Any]:
    ...
    if not isinstance(source_manifest, Mapping):
        _reject("v315_contract_science_source_shape")
    if any(key not in source_manifest for key in SCIENCE_PROJECTION_KEYS):
        _reject("v315_contract_science_source_keys")
    return {
...
def verify_frozen_science_projection(value: Any) -> dict[str, Any]:
    ...
    if not isinstance(value, Mapping) or set(value) != set(SCIENCE_PROJECTION_KEYS):
        _reject("v315_contract_science_projection_keys")
    ...
    if len(encoded) != SCIENCE_PROJECTION_BYTE_COUNT:
        _reject("v315_contract_science_projection_size")
    if sha256_bytes(encoded) != SCIENCE_PROJECTION_SHA256:
        _reject("v315_contract_science_projection_hash")
    return detached
...
def build_frozen_science_projection() -> dict[str, Any]:
    ...
    if predecessor_internal_sha256 != SCIENTIFIC_CONTRACT_INTERNAL_SHA256:
        _reject("v315_contract_science_parent_internal")
...
def build_v39_inherited_preregistration_pins() -> dict[str, Any]:
    """Return detached rejected-v3.9 provenance, never v3.15 authority."""
...
def build_v314_rejection_pins() -> dict[str, Any]:
    """Return immutable V3.14 P/I/F/X evidence, never V3.15 authority."""

    return {
        "preregistration": {
            "commit": V314_PREREGISTRATION_COMMIT,
            "tree": V314_PREREGISTRATION_TREE,
            "path": V314_PREREGISTRATION_PATH,
            "git_blob_sha1": V314_PREREGISTRATION_GIT_BLOB_SHA1,
            "literal_sha256": V314_PREREGISTRATION_LITERAL_SHA256,
            "literal_bytes": V314_PREREGISTRATION_LITERAL_BYTES,
        },
        "implementation": {
            "commit": V314_IMPLEMENTATION_COMMIT,
            "tree": V314_IMPLEMENTATION_TREE,
            "parent": V314_PREREGISTRATION_COMMIT,
        },
        "preflight_failure": {
            "commit": V314_PREFLIGHT_FAILURE_COMMIT,
            "tree": V314_PREFLIGHT_FAILURE_TREE,
            "parent": V314_IMPLEMENTATION_COMMIT,
            "path": V314_PREFLIGHT_FAILURE_PATH,
            "git_blob_sha1": V314_PREFLIGHT_FAILURE_GIT_BLOB_SHA1,
            "literal_sha256": V314_PREFLIGHT_FAILURE_LITERAL_SHA256,
            "literal_bytes": V314_PREFLIGHT_FAILURE_LITERAL_BYTES,
            "internal_sha256": V314_PREFLIGHT_FAILURE_INTERNAL_SHA256,
        ...
        "rejection": {
            "commit": V314_REJECTION_COMMIT,
            "tree": V314_REJECTION_TREE,
            "parent": V314_PREFLIGHT_FAILURE_COMMIT,
            "path": V314_REJECTION_PATH,
            "git_blob_sha1": V314_REJECTION_GIT_BLOB_SHA1,
            "literal_sha256": V314_REJECTION_LITERAL_SHA256,
            "literal_bytes": V314_REJECTION_LITERAL_BYTES,
        },
        "phase1_node_count": 323,
        "phase1_case_sensitive_unique_node_count": 323,
        "phase1_duplicate_node_count": 0,
        "phase1_required_node_count": 22,
...
def build_qualification_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "latest": {
            "phase": QUALIFICATION_PHASE_V315,
...
def validate_effect_counts(value: Any, *, route: str) -> dict[str, int]:
    ...
    if route not in budgets:
        _reject("v315_contract_effect_route")
    if not isinstance(value, Mapping) or set(value) != set(EFFECT_COUNT_KEYS):
        _reject("v315_contract_effect_keys")
    if any(type(item) is not int or item < 0 for item in value.values()):
        _reject("v315_contract_effect_type")
    observed = dict(value)
    if observed != budgets[route]:
        _reject("v315_contract_effect_counts")
...
def projected_pilot_ns(durations_ns: Any) -> int:
    ...
    if (
        ...
        _reject("v315_contract_pilot_durations")
...
def validate_local_production_closure_manifest(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v315_contract_closure_shape")
    paths = item["paths"]
    if (
        ...
        _reject("v315_contract_closure_identity")
    ...
    if (
        ...
        _reject("v315_contract_closure_manifest")
    return item
...
def validate_local_import_paths(value: Any) -> tuple[str, ...]:
    ...
    if (
        ...
        _reject("v315_contract_local_import_shape")
    paths = tuple(value)
    if len(paths) != len(set(paths)):
        _reject("v315_contract_local_import_duplicate")
    allowed = frozenset(LOCAL_IMPORT_ALLOWED_PATHS)
    if any(path not in allowed for path in paths):
        _reject("v315_contract_local_import_outside_closure")
    return paths
...
def validate_preregistration_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v315_contract_prereg_shape")
    expected = {
        "branch": BRANCH_NAME,
    ...
    if item != expected:
        _reject("v315_contract_prereg_ancestry")
    return item
...
def validate_implementation_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v315_contract_impl_shape")
    commit = item["commit"]
    if (
...
def validate_preflight_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v315_contract_preflight_shape")
    commit = item["commit"]
    ...
    if (
        ...
        _reject("v315_contract_preflight_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {PREFLIGHT_ARTIFACT_PATH: "A"},
        code="v315_contract_preflight_delta",
    )
    return item
...
def validate_pause_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v315_contract_pause_shape")
    commit = item["commit"]
    if (
        item["branch"] != BRANCH_NAME
        or not _is_hex(commit, 40)
        ...
        _reject("v315_contract_pause_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {PAUSE_ARTIFACT_PATH: "A"},
        code="v315_contract_pause_delta",
    )
    return item
...
def validate_continuation_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v315_contract_continue_shape")
    commit = item["commit"]
    if (
        item["branch"] != BRANCH_NAME
        or not _is_hex(commit, 40)
        ...
        _reject("v315_contract_continue_ancestry")
    _validate_changed_paths(
        item["changed_paths_from_pause"],
        {CONTINUATION_PREREGISTRATION_PATH: "A"},
        code="v315_contract_continue_delta",
    )
    _validate_changed_paths(
        ...
        code="v315_contract_continue_cumulative_delta",
    )
    return item
...
def validate_result_ancestry(value: Any) -> dict[str, Any]:
    ...
    item = _strict_mapping(value, fields, code="v315_contract_result_shape")
    route = item["route"]
    ...
    if (
        ...
        _reject("v315_contract_result_ancestry")
    _validate_changed_paths(
        item["changed_paths"],
        {RESULT_ARTIFACT_PATH: "A", COMPARISON_PATH: "M"},
        code="v315_contract_result_delta",
    )
    return item
...
def _build_unsigned_contract_manifest() -> dict[str, Any]:
    ...
    if len(development_gates) != 22:
        _reject("v315_contract_development_gate_count")
    return {
        ...
        "v314_rejection_authority": build_v314_rejection_pins(),
...
CONTRACT_MANIFEST_SHA256: Final[str] = (
    "164ad453b6cc08dc36bb88d4a392c86e6cf5123bd95a5587d83b73b980aa323d"
)
...
def build_contract_manifest() -> dict[str, Any]:
    ...
    if observed != CONTRACT_MANIFEST_SHA256:
        _reject("v315_contract_manifest_literal")
    return {**unsigned, "contract_manifest_sha256": observed}


def validate_contract_manifest(value: Any) -> dict[str, Any]:
    """Accept only the exact self-hashed v3.15 manifest."""

    if not isinstance(value, Mapping):
        _reject("v315_contract_manifest_shape")
    ...
    if canonical_json_bytes(candidate) != canonical_json_bytes(expected):
        _reject("v315_contract_manifest_mismatch")
