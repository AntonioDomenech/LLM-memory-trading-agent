...
> Evidence status: the run summarized below is internally valid for commit
> `b2d602c`, but it predates the round-trip replay and `1e-12` win-tolerance
> fixes. It is preserved as attempt 2, not as the final current-code artifact.
> A bounded through-2018 reproduction must supersede it before this branch is
> closed.
...
The first complete development run is
`cftc-cot-development-20260710T174142Z-b4c7e39a`. It used only the 1999-12-31
price warm-up, 2000-2018 AAPL/SPY/QQQ prices, and CFTC reports through
2018-12-31. It finished in 46.34 seconds with zero model calls and $0.00
...
| --- | ---: | ---: | ---: | ---: |
| AAPL buy-and-hold | $47,899.87 | +4,689.99% | - | 100.00% |
| 26 weeks, z=0.75 | $16,567.24 | +1,556.72% | -1.0617 | 34.59% |
| 26 weeks, z=1.25 | $24,659.93 | +2,365.99% | -0.6639 | 51.48% |
| 52 weeks, z=0.75 | $11,793.27 | +1,079.33% | -1.4016 | 24.62% |
| 52 weeks, z=1.25 | $12,062.36 | +1,106.24% | -1.3790 | 25.18% |

At the stricter 10-bps cost, the least-bad 26-week/z=1.25 variant ended at
$23,633.85 versus $47,875.95 for buy-and-hold, retaining only 49.36% of the
...
The immutable run used strict `> 0` for annual/rolling wins. That counted two
...
`1e-12` and uses round-trip parsing for sealed price replay. No trading result,
gate decision, or rejection changes.
