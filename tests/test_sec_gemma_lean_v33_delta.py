...
V33_DELTA_MODULE_SHA256 = "a920d5a689d7dd3b4d96c22c7ce1464acf399f75a8f60249b4d9ceac46e8437f"
LOGIC_PATH = "agent_benchmark/logic.py"
TEST_PATH = "tests/test_logic.py"
DOC_PATH = "docs/prereg.md"
EXPECTED_V33_COUNTERPARTS = {
...
def _make_counterpart_repo(tmp_path: Path) -> dict[str, Any]:
    ...
    _git(repo, "config", "user.email", "offline@example.invalid")
    _git(repo, "config", "core.autocrlf", "false")
    old_path = "agent_benchmark/v32_logic.py"
    new_path = "agent_benchmark/v33_logic.py"
    source = b'def run():\n    return "source-only"\n'
...
def test_default_git_pins_are_real_exact_objects_and_prereg_is_doc_only() -> None:
    ...
    prereg = "d2c3f9e7eac704471c1ddab61943da364a188f77"
    prereg_tree = "e6f5250bee6bb1837948ac7cc7b77112a841a94f"
    base = "c329a5de1099c3d7f21072eae7a12f3537f07121"
    base_tree = "b084fade98637cfc0bfa1b0032ee771fc3fde6b4"
    doc_path = "docs/aapl_sec_gemma_lean_evidence_v3_3.md"
    doc_blob = "a9e0ed7fa937e50abe18ce71b67e02be61d4db78"
    doc_sha256 = "b883deefe42a1b31da9afe0529a418689d72bbcaff27d4340788b8f95bb52d2e"
...
def test_default_new_file_allow_inventories_match_frozen_worktree_structure() -> None:
    expected_paths = tuple(sorted(EXPECTED_V33_COUNTERPARTS))
    ...
    assert tuple(sorted(delta._V33_IMPLEMENTATION_PATHS)) == expected_paths
...
def test_committed_counterpart_rejects_same_symbol_import_hostile_body(
    ...
    # committed-v3.2 semantic comparison.
...
def test_checker_rejects_blank_company_scope_expansion_row_drop_and_special_case(
    ...
    new_path = "agent_benchmark/sec_gemma_lean_v33_source.py"
    baseline = (
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ({"counterpart_path": "agent_benchmark/missing_v32.py"}, "Git rejected"),
    ),
)
...
def test_external_anchor_rejects_delta_body_with_stale_test_literal(
    ...
    _git(repo, "config", "user.name", "Offline Test")
    _git(repo, "config", "user.email", "offline@example.invalid")
    old_path = "agent_benchmark/sec_gemma_lean_v32_delta.py"
    new_path = "agent_benchmark/sec_gemma_lean_v33_delta.py"
    anchor_path = "tests/test_sec_gemma_lean_v33_delta.py"
    ...
    _write(
        repo,
        anchor_path,
        f'V33_DELTA_MODULE_SHA256 = "{benign_sha}"\n'.encode("ascii"),
    )
