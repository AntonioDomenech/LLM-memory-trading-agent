...
V37_DELTA_MODULE_SHA256 = "bada9dc67d168c721a9f48af3505e48e3059897faae86ec9e179741cd7d7afdf"
LOGIC_PATH = "agent_benchmark/logic.py"
TEST_PATH = "tests/test_logic.py"
DOC_PATH = "docs/prereg.md"
EXPECTED_V37_COUNTERPARTS = {
...
def _make_counterpart_repo(tmp_path: Path) -> dict[str, Any]:
    ...
    _git(repo, "config", "user.email", "offline@example.invalid")
    _git(repo, "config", "core.autocrlf", "false")
    old_path = "agent_benchmark/v36_logic.py"
    new_path = "agent_benchmark/v37_logic.py"
    source = b'def run():\n    return "source-only"\n'
...
def test_default_git_pins_are_real_exact_objects_and_prereg_is_doc_only() -> None:
    ...
    prereg = "fcebe9b6de9d2de81e7cc9c79b011b2e0ca1051a"
    prereg_tree = "c2e141d3546da5d11d0ab9d2e120b0685798eac6"
    base = "6f6752416025b5200b7bcb2d3dc96e55f2c456aa"
    base_tree = "234ea6ec46727b35ec7396b375032910b7824736"
    doc_path = "docs/aapl_sec_gemma_lean_evidence_v3_7.md"
    doc_blob = "ec49b15630eac71132d321c88e8e02f7cfa5a488"
    doc_sha256 = "645b4adafc56e71bc71d41780501db85963b5a485d3841230f5a2075b13143a7"
...
def test_default_new_file_allow_inventories_match_frozen_worktree_structure() -> None:
    repo = Path(__file__).resolve().parents[1]
    expected_paths = tuple(sorted(EXPECTED_V37_COUNTERPARTS))
    ...
    assert tuple(sorted(delta._V37_IMPLEMENTATION_PATHS)) == expected_paths
...
def test_committed_counterpart_rejects_same_symbol_import_hostile_body(
    ...
    # committed-v3.6 semantic comparison.
...
def test_checker_rejects_blank_company_scope_expansion_row_drop_and_special_case(
    ...
    new_path = "agent_benchmark/sec_gemma_lean_v37_source.py"
    baseline = (
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ({"counterpart_path": "agent_benchmark/missing_v36.py"}, "Git rejected"),
    ),
)
...
def test_external_anchor_rejects_delta_body_with_stale_test_literal(
    ...
    _git(repo, "config", "user.name", "Offline Test")
    _git(repo, "config", "user.email", "offline@example.invalid")
    old_path = "agent_benchmark/sec_gemma_lean_v36_delta.py"
    new_path = "agent_benchmark/sec_gemma_lean_v37_delta.py"
    anchor_path = "tests/test_sec_gemma_lean_v37_delta.py"
    ...
    _write(
        repo,
        anchor_path,
        f'V37_DELTA_MODULE_SHA256 = "{benign_sha}"\n'.encode("ascii"),
    )
